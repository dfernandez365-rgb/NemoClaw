...
On ordinary routes, the retry hint appears only after deletion succeeds or confirms the sandbox is already absent; failed deletion retains the sandbox and prints manual cleanup guidance.
